 ...
 */
final class Version20230703145012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, site_id INT DEFAULT NULL, last_name VARCHAR(20) DEFAULT NULL, first_name VARCHAR(20) DEFAULT NULL, phone_number VARCHAR(20) NOT NULL, email VARCHAR(180) NOT NULL, admin TINYINT(1) NOT NULL, active TINYINT(1) NOT NULL, password VARCHAR(255) NOT NULL, pseudo VARCHAR(255) NOT NULL, image VARCHAR(100) DEFAULT NULL, INDEX IDX_8D93D649F6BD1646 (site_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
