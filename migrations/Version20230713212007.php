 ...
 */
final class Version20230713212007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, place_id INT DEFAULT NULL, state_id INT NOT NULL, site_id INT DEFAULT NULL, promoter_id INT NOT NULL, name VARCHAR(100) NOT NULL, start_time DATETIME NOT NULL, duration INT NOT NULL, dead_line DATETIME NOT NULL, place_max INT NOT NULL, info LONGTEXT DEFAULT NULL, cancel_reason LONGTEXT DEFAULT NULL, image VARCHAR(50) DEFAULT NULL, INDEX IDX_3BAE0AA7DA6A219 (place_id), INDEX IDX_3BAE0AA75D83CC1 (state_id), INDEX IDX_3BAE0AA7F6BD1646 (site_id), INDEX IDX_3BAE0AA74B84B276 (promoter_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
